...
describe('USERS', () => {
    ...
    describe('POST /api/users/:email', () => {
        test('200: returns with the user successfully logged in', () => __awaiter(void 0, void 0, void 0, function* () {
            const newUser = {
                firstName: 'Abbbbb',
                lastName: 'Abbbbb',
            ...
            const addNewUser = yield request(app)
                .post('/api/users')
                .send(newUser)
                .expect(201);
...
describe('EVENTS', () => {
    ...
    describe('GET /api/events/eventById/:eventId', () => {
        test('200: responds with the event', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const addEvent = yield new EventModel(newEvent).save();
            const findEvent = yield EventModel.find({
    ...
    describe('PATCH /api/events/:eventName', () => {
        ...
        test('200: responds with the event with updated votes on restaurant', () => __awaiter(void 0, void 0, void 0, function* () {
            const updateBody = {
                restaurantVotes: [
                    {
